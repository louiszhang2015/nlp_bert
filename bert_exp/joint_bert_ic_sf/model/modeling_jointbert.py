...
class JointBERT(BertPreTrainedModel):
    def __init__(self, config, intent_label_lst, slot_label_lst):
        ...
        self.intent_classifier = IntentClassifier(config.hidden_size, self.num_intent_labels, arg["dropout_rate"])
        self.slot_classifier = SlotClassifier(config.hidden_size, self.num_slot_labels, arg["dropout_rate"])
    ...
    def forward(self, input_ids, attention_mask, token_type_ids, intent_label_ids, slot_labels_ids):
        ...
        if slot_labels_ids is not None:
            if arg["use_crf"]:
                ...
                slot_loss_fct = nn.CrossEntropyLoss(ignore_index=arg["ignore_index"])
